...
function Permisos() {
  return (
    <AdminLayout
      ...
      subtitle="Emisión y gestión de comprobantes"
    >
        ...
        <div className="rounded-xl border bg-card p-6 shadow-sm">
          <div className="rounded-xl border-2 border-dashed border-primary/30 bg-primary/5 p-6">
            ...
            <div className="my-5 grid grid-cols-[auto_minmax(0,1fr)] gap-4">
              ...
              <dl className="grid content-center gap-y-1.5 text-sm">
                <div>
                  ...
                  <dd className="font-semibold">Juan Pérez González</dd>
                </div>
                <div>
                  <dt className="text-xs text-muted-foreground">RUT</dt>
                  <dd className="font-medium">12.345.678-9</dd>
                </div>
                <div>
            ...
            <div className="grid grid-cols-2 gap-3 border-t border-primary/20 pt-4 text-sm">
              ...
              <div>
                <div className="text-xs text-muted-foreground">Paso</div>
                <div className="font-medium">Los Libertadores</div>
              </div>
              <div>
                <div className="text-xs text-muted-foreground">Cabina asignada</div>
                <div className="font-medium">N° 2</div>
              </div>
            </div>
